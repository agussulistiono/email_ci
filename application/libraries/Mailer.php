...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'pengirim@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'nama'; // Isikan dengan nama pengirim
    protected $password = 'password'; // Isikan dengan password email pengirim
